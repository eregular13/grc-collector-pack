...
- **Observability** — `python3 -m dropbox status` and the operator MCP conductor (`scope_status`, `orchestrator_plan`, `orchestrator_status`, `stage_*`, `farm_slots`, `export_ciso_poam`).
