...
SENSORS = ("cloud", "nmap", "vuln", "wazuh", "identity", "easm", "k8s", "code", "saas", "dns_email", "mdm")
...
def cmd_schedule(args: argparse.Namespace) -> int:
    ...
    summary = schedule(
        ...
        dest_out=dest_out,
        extra=extra,
        write_pack_in=bool(getattr(args, "write_pack_in", False)),
    )
...
def build_parser() -> argparse.ArgumentParser:
    ...
    mcp.add_argument("tool", help="serve|scope_status|orchestrator_plan|orchestrator_status|stage_*|farm_slots|farm_slot_status|farm_toolbin_status|export_ciso_poam|keep_status|keep_ciso")
