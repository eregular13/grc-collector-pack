...
blockers remain (CTA; real KEEP `in/` 0/4; Eval `npm start`;
DESKTOP Docker compose on a real host — this VM `compose_lab`
absent ≠ PASS). Paying-day **FAIL**. SAMPLE ≠ client.
DEMO ≠ client. RiskReady stay-out.
