...
# SAMPLE/DEMO: fixture Covey pack_drop (nmap + rustscan + httpx + unicornscan + sslscan + tlsx + whatweb + hping3) + honeypot → out/ciso-assistant. Not a client. Paying-day stays FAIL.
prove-ciso:
