...
| Mapped web/TLS POA&M `pack_mapped ≥ 4` | PASS (`5` on docker-estate; extra expired / TLS1.0 / mismatch / dirlist / stub_status / .git / cookie / CORS / .env / dump.sql / phpinfo / metrics / openapi / basic-http / sourcemap) |
