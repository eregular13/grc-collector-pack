...
- `scheduled_completion_date` = Evergreen default schedule: detection + 15 days (Critical), 30 (High), 90 (Moderate), 180 (Low). `due` stays blank until a human commits a date.
