...
CONTROL_CLASS: dict[str, str] = {
    ...
    "Stop trusting wildcard certificates too broadly": "tls_crypto",
    "Publish a CAA DNS record": "tls_crypto",
    "Set the missing web security header": "config_benchmark",
    "Disable password-never-expires on accounts": "identity_password",
    "Require passwords on every account": "identity_password",
    "Deploy LAPS for local administrator passwords": "identity_password",
    "Restrict DnsAdmins membership": "identity_privilege",
    "Remove SID History from trusted accounts": "identity_privilege",
    "Enable SID filtering on trusts": "identity_privilege",
    "Disable DES encryption types for Kerberos": "identity_password",
    "Review high-value directory group membership": "identity_privilege",
    "Review informational PingCastle finding": "identity_privilege",
    "Restrict Account Operators membership": "identity_privilege",
    "Restrict Print Operators membership": "identity_privilege",
    "Restrict Server Operators membership": "identity_privilege",
    "Restrict Schema Admins membership": "identity_privilege",
    "Restrict Enterprise Admins membership": "identity_privilege",
    "Restrict Administrators membership": "identity_privilege",
}
...
FINDING_TYPE_CLASS: dict[str, str] = {
    ...
    "web_missing_header": "config_benchmark",
