...
live_finding_classes: Cleartext HTTP; Missing HSTS; Missing X-Frame-Options/CSP (mapped as Missing web security headers); Server banner disclosure; Git metadata exposed; Directory listing enabled; Untrusted TLS certificate
pack_mapped: 7
poam_rows_from_estate: 7
