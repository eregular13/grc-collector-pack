...
| `farm_toolbin_status` | Resolve + SCOPE honesty | `will_run` may be true for DEMO lab stubs; `live_ready` stays 0 on DEMO SCOPE or stubs. Real `--live` needs signed non-DEMO SCOPE + allowlisted real binary |
