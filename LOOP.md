...
- Next: CIS-CAT / osquery file-drop polish (no live tools)
- Done this window: SARIF, cloud ASFF, HK/Lynis, testssl/Maester, k8s, nmap, BloodHound CE, Fleet, Nuclei JSON file-drop
